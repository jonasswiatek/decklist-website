  ...
  return (
    <PageContainer size="default">
      ...
      <div className="mt-6 space-y-4 text-muted-foreground">
        ...
        <h2 className="pt-2 text-2xl font-semibold text-foreground">Email Information</h2>
        <p>
        ...
        <h2 className="pt-2 text-2xl font-semibold text-foreground">Cookies</h2>
        <p>
        ...
        <h2 className="pt-2 text-2xl font-semibold text-foreground">Google Authentication</h2>
        <p>
        ...
        <h2 className="pt-2 text-2xl font-semibold text-foreground">Amazon Web Services (AWS)</h2>
        <p>
        ...
        <h2 className="pt-2 text-2xl font-semibold text-foreground">Your Data Rights</h2>
        <p>
